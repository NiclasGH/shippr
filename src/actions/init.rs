...
pub fn initialize_configuration(deployment_name: String) -> Result<()> {
    ...
    create_file(&deployment_name, "deployment.yaml", Some(&default_deployment_file))?;
...
fn create_file(directory_name: &str, file_name: &str, content_optional: Option<&str>) -> Result<()> {
